      ...
      <div className="max-w-6xl mx-auto">
            ...
            <CardContent className="p-8">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-foreground">Chips Novos — Incubadora</h3>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-foreground text-sm">Maturação de 30 a 60 dias consistente</span>
                </div>
                <div className="flex items-start gap-3">
                  <Shield className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-foreground text-sm">Construção gradual de reputação</span>
                </div>
                <div className="flex items-start gap-3">
                  <HeartPulse className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-foreground text-sm">Health Score otimizado desde o início</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-foreground">Chips Antigos — Manutenção</h3>
                </div>
              </div>
              <p className="text-muted-foreground mb-5">
                O chip já vende, mas sofre denúncias. A Eazy Flow roda <strong>em paralelo</strong> para manter o Health Score alto.
              </p>
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <Smartphone className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-foreground text-sm">Continue vendendo sem parar</span>
                </div>
                <div className="flex items-start gap-3">
                  <Shield className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-foreground text-sm">Aquecimento em paralelo com a operação</span>
                </div>
                <div className="flex items-start gap-3">
                  <HeartPulse className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
                  <span className="text-foreground text-sm">Diluição ativa de denúncias</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <Card key={index} className="border border-purple-100 hover:border-primary/30 hover:shadow-lg transition-all duration-300 group">
